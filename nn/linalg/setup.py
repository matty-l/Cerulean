"""
	This is the Setup File for the Cerebro Linalg package
...
if numargs == 1 or 'help' in arguments:
	print( "setup.py options:\n\t\"install\" Installs the C dependencies for Cerebro")
...
if 'install' in arguments: # note the unjudicious use of "in" - don't mix args on pain of death
	...
	case_module = Extension('CaLalg',sources=['Linalg.c','AlgRoutines.c'],
